...
export default function Dashboard() {
  ...
  // Badge data
  const userBadges = [
    { id: 1, name: "Clear Speaker", icon: <Mic size={24} />, description: "Achieved excellent clarity in speech", earned: true, level: "gold" },
    { id: 2, name: "Body Language Pro", icon: <Users size={24} />, description: "Mastered non-verbal communication", earned: true, level: "silver" },
    { id: 3, name: "Perfect Pitch", icon: <Zap size={24} />, description: "Maintained ideal voice pitch and tone", earned: true, level: "bronze" },
    { id: 4, name: "Grammar Master", icon: <CheckSquare size={24} />, description: "Displayed excellent grammar in writing", earned: false, level: "locked" },
    { id: 5, name: "Conversation Expert", icon: <MessageSquare size={24} />, description: "Successfully navigated complex dialogues", earned: false, level: "locked" },
    { id: 6, name: "Presentation Star", icon: <Star size={24} />, description: "Delivered an outstanding presentation", earned: false, level: "locked" },
  ];
